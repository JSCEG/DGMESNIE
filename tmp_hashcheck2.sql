...
SELECT cp.CambioPropuestoId, decision.CambioDecisionId, decision.DecisionCampo
...
SELECT CAST(CASE WHEN @HashPaquete = @HashActual THEN 1 ELSE 0 END AS INT) AS EsVigente;
SELECT @HashPaquete AS HashPaquete, @HashActual AS HashActual;
