            ...
            <div class="kanban-col" data-col="${col}">
                ...
                ${items.map(t => {
                    ...
                    const stagesCount = t.etapas && t.etapas.length > 0
                        ? `<span class="badge-etapas" style="font-size:0.68rem;font-weight:700;color:var(--guinda);background:rgba(155, 34, 71,0.06);padding:1px 5px;border-radius:4px;display:inline-flex;align-items:center;gap:3px;margin-left:auto;" title="Este tema tiene ${t.etapas.length} etapas"><i class="bi bi-signpost-split" style="font-size:0.62rem;"></i> ${t.etapas.length} etapas</span>`
                        : '';
                    return `
